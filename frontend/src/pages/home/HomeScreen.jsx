...
{/*     cool optimixarion hack for images */}
        {imageLoading && (
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          {/* Gradient Background */}
          <div className="absolute w-full h-full top-0 left-0 bg-gradient-to-b from-black via-transparent to-transparent -z-10" />
          ...
          <div className="flex mt-8">
            ...
            >
              <PlayIcon className="size-6 mr-2 fill-black" />
              Play
            </Link>
